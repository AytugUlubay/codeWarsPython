...
def ski_jump(mountain):
    ...
    lnght = round(lng, 2)
    if lnght < 10:
        return "{:.2f} metres: He's crap!".format(lnght)
    elif 10 <= lnght < 25:
        return "{:.2f} metres: He's ok!".format(lnght)
    elif 25 <= lnght < 50:
        return "{:.2f} metres: He's flying!".format(lnght)
    return "{:.2f} metres: Gold!!".format(lnght)
