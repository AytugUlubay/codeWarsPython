...
def leader_b(user, user_score, your_score):
    if your_score>user_score:
        ...
        a=(user_score-your_score)//3
        b=(user_score-your_score)%3
        if a+b>1000:
            return("To beat {}'s score, I must complete {} Beta kata and {} 8kyu kata. Dammit!".format(user,a,b))
    return("To beat {}'s score, I must complete {} Beta kata and {} 8kyu kata.".format(user,a,b))
